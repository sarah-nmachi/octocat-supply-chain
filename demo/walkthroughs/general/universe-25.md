...
> [!WARNING]
> Please note that all demos below have been put into their appropriate places in other walkthrough files. This file only exists for historic purposes.
...
> [!TIP]
> **Using 3rd Party Agents:** When dispatching work to the Coding Agent, you can select an alternative agent such as **Claude Code** or **Codex** in the Mission control tab on the web or the **Agent Picker** in VSCode.
...
3. **Mission Control Overview**: Navigate to <https://github.com/copilot/agents>, then:
    ...
    4. Kick off a new session with the ESLint Rule from above. **Optional:** Open the **Web agents panel** to show how you can select **Claude Code** or **Codex** as an alternative to the default Copilot Coding Agent.
